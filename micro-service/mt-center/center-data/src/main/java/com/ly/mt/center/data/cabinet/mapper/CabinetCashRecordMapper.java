...
public interface CabinetCashRecordMapper {
     ...
     * @return
     */
    List<CabinetCashRecord> selectRecordByUserIdToday(@Param("userId") String userId, @Param("todayStartTime") String todayStartTime, @Param("todayEndTime") String todayEndTime);
     ...
     * @return
     */
    List<CabinetCashRecord> selectRecordByStatus(CabinetCashRecord record);
    /**
     * 
     * @param id
     * @return
     */
    CabinetCashRecord selectByPrimaryKey(String id);
