...
public class CreateCooperationResVO {
    ...
    private Date take_effect_datetime;
    /**
     * 合同失效期
     */
    @ApiModelProperty("合同失效时间")
    private Date lose_effect_datetime;
    /**
     * 合同id
     */
    ...
    public void setDescate_type(int decorate_type) {
    ...
    public Date getTake_effect_datetime() {
        return take_effect_datetime;
    }

    public void setTake_effect_datetime(Date take_effect_datetime) {
        this.take_effect_datetime = take_effect_datetime;
    }

    public Date getLose_effect_datetime() {
        return lose_effect_datetime;
    }

    public void setLose_effect_datetime(Date lose_effect_datetime) {
