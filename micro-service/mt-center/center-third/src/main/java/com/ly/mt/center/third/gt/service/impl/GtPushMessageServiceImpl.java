package com.ly.mt.center.third.gt.service.impl;
...
import com.ly.mt.center.third.gt.service.GtPushMessageService;
...
import static com.ly.mt.center.third.gt.dict.GtOpenType.OPEN_URL;
 ...
 * @description 个推服务接口
 */
@Service("gTPushMessageServiceImpl")
public class GtPushMessageServiceImpl implements GtPushMessageService {
    private static final Logger LOGGER = LoggerFactory.getLogger(GtPushMessageServiceImpl.class);
    @Resource
    YmlConfig yml;
    ...
    public ResponseJson pushSingle(JSONObject jsonObject) throws Exception {
        String appKey = yml.getGtAppKey();
        String appId = yml.getGtAppId();
        String masterSecret = yml.getGtMasterSecret();
