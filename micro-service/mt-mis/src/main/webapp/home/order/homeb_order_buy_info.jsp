                    ...
                    <td>
                        <table align="center" border="1" width="97%" style="border-collapse: collapse;text-align: center;">
                            <tr>
                                ...
                                <td style="background-color: lightgrey;">物流公司</td>
                            ...
                            <tr>
                                <td style="height: 35px;">
                                    <c:choose>
                                        <c:when test="${not empty order.distributeTypeName}">${order.distributeTypeName}</c:when>
                                        <c:otherwise><span style="color:red;">—</span></c:otherwise>
                                    </c:choose>
                                </td>
                                <td>
                                    <c:choose>
                                        <c:when test="${not empty order.logisticsName}">${order.logisticsName}</c:when>
                                        <c:otherwise><span style="color:red;">—</span></c:otherwise>
                                    </c:choose>
                                </td>
                                <td>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${not empty order.logisticsStateName}">${order.logisticsStateName}</c:when>
                                        <c:otherwise><span style="color:red;">—</span></c:otherwise>
                                    </c:choose>
                                </td>
                                <td>
                    ...
                    <td>
                        <table align="center" border="1" width="97%" style="border-collapse: collapse;text-align: center;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${not empty order.userRegisterTime}">${order.userRegisterTime}</c:when>
                                        <c:otherwise><span style="color:red;">—</span></c:otherwise>
                                    </c:choose>
                                </td>
                                <td>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${not empty order.userMobile}">${order.userMobile}</c:when>
                                        <c:otherwise><span style="color:red;">—</span></c:otherwise>
                                    </c:choose>
                                </td>
                            </tr>
