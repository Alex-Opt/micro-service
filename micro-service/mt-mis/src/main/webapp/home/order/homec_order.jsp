    ...
    <div region="north" title="查询条件" border="false" style="height:170px;background:#fafafa;">
        <table id="tableSrarch" align="center">
            ...
            <tr>
                ...
                <td>配送信息:</td>
                <td style="width: 250px"><select id="distributionId"/></td>

                <td>订单类型:</td>
                <td style="width: 250px"><select id="orderType"/></td>
...
<script type="text/javascript" src="/js/home/order/homec_order.js?ver=${sv}"></script>
</body>
</html>