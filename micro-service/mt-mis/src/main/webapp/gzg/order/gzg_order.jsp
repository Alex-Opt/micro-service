...
<div class="easyui-layout" fit="true" modal="true">
    ...
    <div region="north" title="查询条件" border="false" style="height:138px;background:#fafafa;">
        <table id="tableSrarch" align="center">
            ...
            <tr>
                <td>门店UID:</td>
                <td style="width: 250px"><input id="hotelId" class="easyui-textbox"/></td>

                <td>订单编号:</td>
                <td style="width: 250px"><input id="id" class="easyui-textbox"/></td>

                <td>格子柜编码:</td>
                <td style="width: 250px"><input id="code" class="easyui-textbox"/></td>
...
<script type="text/javascript" src="/js/gzg/order/gzg_order.js?ver=${sv}"></script>
</body>
</html>