package com.ly.mt.home.tob.buycar.vo;
...
public class BuyCar {
    ...
    public BuyCar(String shopId) {
        this.shopId = shopId;
    }

    public BuyCar(Map<String, CarSku> items, Map<String, CarSku> averageItems, String buyerId, String sellerId, String shopId) {
        this.items = items;
