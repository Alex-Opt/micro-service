...
@ApiModel
public class CreateCooperationResVO {
    /**
     * 店铺id
     */
    ...
    public String getForecast_flow() {
        return forecast_flow;
    }

    public void setForecast_flow(String forecast_flow) {
    ...
    public String getDescate_type() {
        return descate_type;
    }

    public void setDescate_type(String descate_type) {
    ...
    public String getIs_desposit() {
        return is_desposit;
    }

    public void setIs_desposit(String is_desposit) {
