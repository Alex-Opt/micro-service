package com.ly.mt.cabinet.c.good.controller;
...
@RestController
@RequestMapping("/cabinet/c/gzg/goods")
@Api(value = "goods controller", tags = {"goods"})
public class GzgGoodsController {
    private static final Logger LOGGER = LoggerFactory.getLogger(GzgGoodsController.class);
    ...
    public ResponseJson goodsList( @RequestParam(required = true) String gzgCode,
        ...
        try {
            responseJson = gzgGoodsService.gzgGoodsList(gzgCode,userId,tname);
