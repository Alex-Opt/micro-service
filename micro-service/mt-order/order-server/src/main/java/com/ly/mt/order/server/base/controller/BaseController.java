package com.ly.mt.order.server.base.controller;

import com.alibaba.fastjson.JSONObject;
import com.ly.mt.core.base.util.JsonUtil;
import com.ly.mt.core.base.util.StringUtil;
import com.ly.mt.order.server.base.util.SpringBeanUtil;
...
public class BaseController {
    ...
    public JSONObject requestDistribute(@RequestBody JSONObject jsonObject) {
        ...
        try {
            ...
            LOGGER.info("order-server:接口={},方法={},执行耗时={}", serviceName, functionName, String.valueOf(end - start));
            return jsonObject;
        } catch (Exception e) {
            LOGGER.error("order-server:接口={},方法={},调用异常:", serviceName, functionName, e);
            return JsonUtil.getErrorJson(RESULT_CODE_SYSTEM_ERROR);
        }
    }
}