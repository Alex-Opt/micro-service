...
public enum OrderMethodEnum {
    USER_GET_BY_MOBILE("userProfitsImpl", "getUserByMobile", "用户中心-根据电话查询用户信息"),
    ...
    TRADE_ORDER_CHECK_ADDRESS_HOUR("tradeOrdersServiceImpl", "orderCheckAddressHour", "订单管理-校验订单的收货地址是否支持一小时达"),
    TRADE_ORDER_CHECK_BLUETOOTH("tradeOrdersServiceImpl", "orderCheckBlueTooth", "订单管理-校验蓝牙商品"),
    TRADE_ORDER_CHECK_ADDRESS_DAY("tradeOrdersServiceImpl", "orderCheckAddressDay", "订单管理-校验订单的收货地址是否支持次日达"),
    ...
    TRADE_ORDER_DELIVERY_INFO_SMS("tradeOrdersServiceImpl", "getOrderDeliveryInfoSms", "订单管理-查询订单发货物流信息接口"),
    ...
    TRADE_ORDER_WX_REFUND("tradeOrderRefundServiceImpl","wxRefund","微信退款"),
