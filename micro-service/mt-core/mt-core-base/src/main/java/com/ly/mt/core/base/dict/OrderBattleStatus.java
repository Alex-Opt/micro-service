 ...
 * 发货单的订单快递状态枚举类
 */
public enum OrderBattleStatus {
    ORDER_BATTLE_STATUS_NOT_BATTLE("1", "未抢单"),
    ORDER_BATTLE_ALREADY_OTHER_GRAB("2","已被别人抢"),
    ORDER_BATTLE_STATUS_ALREADY_BATTLE("3", "已被抢单"),
    ORDER_BATTLE_GIVE_UP_GRAB("4","放弃抢"),
    ...
    ORDER_BATTLE_STATUS_REJECT_SIGN("25", "商品被拒签"),
    ORDER_BATTLE_STATUS_GOODS_RETURNING("27", "商品申请退货中"),
    ORDER_BATTLE_STATUS_GOODS_RETURNED("29", "商品退货退款完成");


    private final String id;
    private final String name;

    OrderBattleStatus(String id, String name) {
        this.id = id;
        this.name = name;
    }
