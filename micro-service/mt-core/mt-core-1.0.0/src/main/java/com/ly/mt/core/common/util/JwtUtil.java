...
import com.ly.mt.core.common.dict.YHHDAccessKeyEnum;
...
public class JwtUtil {
    ...
    public static String getEncodedJWT () throws UnsupportedEncodingException {
        Algorithm algorithm = Algorithm.HMAC256(YHHDAccessKeyEnum.THREE_ELE_KEY_SECRET.getName());
        String token = JWT.create()
                .withIssuer(YHHDAccessKeyEnum.THREE_ELE_ACCESS_KEY.getName())
