...
public enum UserMethodEnum {
    ...
    B_SHOP_USER_H5_MOBILE_LOGIN("loginShopUserServiceImpl","h5mobileLogin","b端h5页面手机号，验证码登录"),    B_SHOP_USER_FINISH_INFO("shopUserInfoServiceImpl","finishInfo","B端用户基本信息补全"),
